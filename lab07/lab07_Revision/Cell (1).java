public class Cell {
    ...
    private boolean isDisposalItem;
    ...
    public String display() {
        ...
        if (isMine && !isDisposalItem) {
            return MinesweeperGame.MINE_SYMBOL;
        }

        if (isDisposalItem) {
            return MinesweeperGame.DISPOSAL_ITEM_SYMBOL;
        }
    ...
    public boolean isDisposalItem(){ 
        return isDisposalItem; 
    }
    ...
    public void setDisposalItem(boolean item){
        this.isDisposalItem = item; 
    }
